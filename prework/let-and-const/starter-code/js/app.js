...
const displayPics = () => {
  ...
  // console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the lettiable declaration from `let to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT
    // 1- Because we declared rando with let inside a the scope and we cannot call it outside the scope.
